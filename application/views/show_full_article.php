...
<body style="background-color:#F0F2F1">
  <div class="span10" style="height:50px;width:100%;margin-top:5px;margin-left:0;">
	...
	<span id="like1" style="font-family:'calibri';font-size:20px;color:#CE6A6B;margin-left:15px;line-height:25px;"><?php echo $numOfLike?> Likes </span>
	...
	<span id="like2" style="font-family:'calibri';font-size:20px;color:#CE6A6B;margin-left:15px;line-height:25px;"><?php echo $numOfLike ?> Likes </span>

        </div> 
	</div>
	
        <div class="span2" style="margin-left:280px;">
            <span style="font-family:'calibri';font-size:20px;color:#CE6A6B;margin-left:15px;line-height:25px;">Comments</span>
        </div>
		...
		<div class="span1" style="height:10px;">
         ...
         <div id="commentBlock" class="span9" style="margin-left:0px;background-color:#FFF;height:620px;width:725px;margin-top:65px;overflow-y:scroll;overflow-x:hidden">
