...
$(document).ready(function(e) {
		...
		$("#dislike").click(function(e) {
			...
			success:function(html)
   		{		
			$("#like1").html(html+" likes");
			$("#like_box").css({"display":"block"});	
			$("#dislike_box").css({"display":"none"});	
...
<body style="background-color:#F0F2F1">
  <div class="span10" style="height:50px;width:100%;margin-top:5px;margin-left:0;">
	...
	<div id="Like">
        <div id="like_box" class="span2" style="margin-left:280px;display:none">
            <a href="#" style="text-decoration:none"><span id="like" style="font-family:Calibri;font-size:20px;font-weight:bold;color:#fff;margin-left:10px;margin-left:-280px;line-height:25px;background-color:#669ACC">Like</span></a>
	<span id="like1" style="font-family:'Open Sans';font-size:20px;color:#CE6A6B;margin-left:15px;line-height:25px;"><?php echo $numOfLike?> Likes </span>

        </div> 
        <div class="span2" style="margin-left:280px;display:none" id="dislike_box">
            <a href="#" style="text-decoration:none"><span id="dislike" style="font-family:Calibri;font-size:20px;font-weight:bold;color:#fff;margin-left:10px;margin-left:-280px;line-height:25px;background-color:#669ACC;">Dislike</span></a>
	<span id="like2" style="font-family:'Open Sans';font-size:20px;color:#CE6A6B;margin-left:15px;line-height:25px;"><?php echo $numOfLike ?> Likes </span>

        </div> 
	</div>
	
        <div class="span2" style="margin-left:280px;">
            <span style="font-family:'Open Sans';font-size:20px;color:#CE6A6B;margin-left:15px;line-height:25px;">Comments</span>
        </div>
        ...
        <div class="span9" style="margin-left:0;margin-top:0;background-color:#FFF;height:40px;width:735px;margin-top:40px;">
            <div class="span9" style="width:640px;margin-left:0;height:40px;">
                 <input type="text" id="comment" placeholder="Enter your answers here..." style="border-radius:0;height:20px;width:700px;border:1px solid #000;"/>
            </div>
            <div class="span9" style="width:90px;background-color:#669ACC;margin-left:-5px;height:43px;">
              <a href="#" style="text-decoration:none"><span id="post_comment" style="font-family:Calibri;font-size:30px;font-weight:bold;color:#fff;margin-left:10px;">SEND</span></a>
            </div>
		<div class="span1" style="height:10px;">
         ...
         <div id="commentBlock" class="span9" style="margin-left:0px;background-color:#FFF;height:480px;width:725px;margin-top:65px;overflow-y:scroll;overflow-x:hidden">
            <!--div for answers..it will repeat--don't forget to alternate css>-->
		<?php foreach($com as $row) { ?>
            
              <div class="span2" style="height:90px;margin-left:5px;background-color:#CC8847;width:110px;">&nbsp&nbsp&nbsp&nbsp Posted by<br><br><?php $email = $row->posted_by;
