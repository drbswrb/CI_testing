...
<body style="background-color:#F0F2F1">
  <div class="span10" style="height:50px;width:100%;margin-top:5px;margin-left:0;">
      ...
      <div class="span3" style="height:700px;background-color:#1BBC9B;margin-left:80px;margin-top:20px;overflow-y:scroll;overflow-x:hidden">
		    <div class="span3" style="margin-left:0 px;margin-top:5px;height:40px">
	...
	<?php foreach($art as $row) {
		$present_question=$row->question; } ?>
	   <?php foreach($que as $row){ 
		$query = mysql_query("select * from answers where question_id = '{$row->question_id}'");
			$ans = mysql_num_rows($query); 
	if($row->question!=$present_question){ ?>
        <div class="span3" style="height:100px;background-color:#fff;margin-left:5px;width:198px;margin-top:30px;">
           <div class="span3" style="margin-left:8px;margin-top:10px;">
              <span style="line-height:10px;font-size:14px;font-family:'Open Sans';color:#7474A3"><?php echo $row->question ?></span>
           </div>

           <div class="span3" style="margin-left:0px;margin-top:30px;">
              <img src="<?php echo base_url()?>Assets/images/votes.png" style="width:12px;height:12px;margin-top:-1px;margin-right:4px;margin-left:8px;"/><span style="line-height:10px;font-size:13px;font-family:'Open Sans';color:#1BBC9B"><?php echo $row->number_of_likes?> Likes</span>
              <img src="<?php echo base_url()?>Assets/images/answer.png" style="width:12px;height:12px;margin-top:-1px;margin-right:4px;margin-left:8px;"/><span style="line-height:10px;font-size:13px;font-family:'Open Sans';color:#669ACC"><?php echo $ans?> answers</span>
