...
class Md_create_user extends CI_Model {
	...
	{	
		...
		$message .= $url . '/activate.php?email=' . urlencode($user_email) . "&key=$activation"; //Confirmation message

		mail($user_email, 'Registration Confirmation', $message, 'From:'.$browseboard_email);
